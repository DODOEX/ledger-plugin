...
nano_models.forEach(function(model) {
  ...
  const {data} = await contract.populateTransaction.withdraw(fromTokenAmount);
  ...
  await sim.navigateAndCompareSnapshots('.', model.name + '_swap_weth9_withdraw', [right_clicks, 0]);
