...
The script will build a docker image and attach a console.(time consuming)
...
```
 ...
 When the docker image is running go to the "app-plugin" folder and build the ".elf" files.
